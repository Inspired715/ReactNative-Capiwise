...
export default function PerformanceEtf(props) {
  ...
  const getETFStocks = () => {
    ...
    let { max, min } = getMinMaxValueFromPerformance(response?.performance?.avgAnnualReturns)
    setMaxValue(max)
    setMinValue(min)
    setBarData(response?.performance?.avgAnnualReturns ? [
      {
        value: response?.performance?.avgAnnualReturns?.self?.Returns_1Y || "NA",
        spacing: 1,
        labelWidth: 14,
        frontColor: "#B8B9BB",
      },
      {
        value: response?.performance?.avgAnnualReturns?.index?.Returns_1Y || "NA",
        frontColor: "#0F69FE",
      },
      {
        value: response?.performance?.avgAnnualReturns?.self?.Returns_3Y || "NA",
        spacing: 1,
        frontColor: "#B8B9BB",
      },
      {
        value: response?.performance?.avgAnnualReturns?.index?.Returns_3Y || "NA",
        frontColor: "#0F69FE",
      },
      {
        value: response?.performance?.avgAnnualReturns?.self?.Returns_5Y || "NA",
        spacing: 1,
        frontColor: "#B8B9BB",
      },
      {
        value: response?.performance?.avgAnnualReturns?.index?.Returns_5Y || "NA",
        frontColor: "#0F69FE",
      },
      {
        value: response?.performance?.avgAnnualReturns?.self?.Returns_10Y || "NA",
        frontColor: "#B8B9BB",
        spacing: 1,
      },
      {
        value: response?.performance?.avgAnnualReturns?.index?.Returns_10Y || "NA",
        frontColor: "#0F69FE",
      },
      {
        value: response?.performance?.avgAnnualReturns?.self?.Returns_YTD || "NA",
        frontColor: "#B8B9BB",
        spacing: 1,
      },
      {
        value: response?.performance?.avgAnnualReturns?.index?.Returns_YTD || "NA",
        frontColor: "#0F69FE",
      },
    ] : []);

    getStockHistoricalData(response?.performance?.hypotheticalGrowth, '1y')
    setETFSummary(response);
    
    const riskreturns = response?.performance?.riskreturnComparison
    ...
    <ScrollView contentContainerStyle={globalStyle.scrollContainer}>
      <View style={globalStyle.container}>
        ...
        <View style={[globalStyle.justifyBetween, globalStyle.alignItemsCenter]}>
          ...
          <Text style={[globalStyle.h2, { letterSpacing: 0 }]}>As of{" "}
            {formatDateAnalysis(etfSummary?.asof)}
          </Text>
        </View>
        {barData && <View style={{ paddingTop: 10}}>
            ...
            <View style={{ flexDirection: 'row', gap:10 }}>
              ...
              <View style={{ flexDirection: 'column', alignItems: 'center',width:50 }}>
                ...
                <Text style={[globalStyle.h2, { fontSize: 8, letterSpacing: 0.1 }]}>
                  {formatDateAnalysis(etfSummary?.overview?.statistics?.inceptionDate)}
                </Text>
              </View>
            </View>
          </View>
          <View style={{ gap: 16, flexDirection: 'row', justifyContent: 'flex-end', marginTop: 18 }}>
            <View style={{ flexDirection: "row", gap: 4, alignItems: 'center' }}>
              ...
              >
                {etfSummary?.overview?.details?.symbol}
              </Text>
            </View>
            <View style={[globalStyle.alignItemsCenter, { gap: 4 }]}>
              ...
              >
                {etfSummary?.overview?.details?.exchange} 100 TR USD
              </Text>
            </View>
          </View>
        </View>}
        ...
        <View style={[globalStyle.justifyBetween, { marginTop: 20 }]}>
          <View style={[globalStyle.justifyBetween, { width: '60%' }]}>
            <Text style={[globalStyle.h2, { letterSpacing: 0.1 }]}>
              {etfSummary?.overview?.details?.symbol} vs. Index</Text>
          ...
          <View>
            <Text style={[globalStyle.h3, { letterSpacing: -0.07, color: '#FFF' }]}>
              {etfSummary?.overview?.details?.exchange} 100 TR USD</Text>
          </View>
        </View>
        ...
        <View style={[globalStyle.justifyBetween, { marginTop: 13 }]}>
          <View style={[globalStyle.justifyBetween, { width: '60%' }]}>
            ...
            {etfSummary?.performance?.avgAnnualReturns?.self?.Returns_1Y &&
              etfSummary?.performance?.avgAnnualReturns?.self?.Returns_1Y > 0 ?
              <Text style={[styles.statisticsValue, { color: "#2EBD85" }]}>
                +{getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.self?.Returns_1Y)}%
              </Text>
          ...
          <View>
            {etfSummary?.performance?.avgAnnualReturns?.index?.Returns_1Y &&
              etfSummary?.performance?.avgAnnualReturns?.index?.Returns_1Y > 0 ?
              <Text style={[styles.statisticsValue, { color: "#2EBD85" }]}>
                +{getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.index?.Returns_1Y)}%
              </Text>
              : <Text style={[styles.statisticsValue, { color: "#F00" }]}>
                {getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.index?.Returns_1Y)}%
              </Text>
        ...
        <View style={[globalStyle.justifyBetween, { marginTop: 13 }]}>
          <View style={[globalStyle.justifyBetween, { width: '60%' }]}>
            ...
            {etfSummary?.performance?.avgAnnualReturns?.self?.Returns_3Y &&
              etfSummary?.performance?.avgAnnualReturns?.self?.Returns_3Y > 0 ?
              <Text style={[styles.statisticsValue, { color: "#2EBD85" }]}>
                +{getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.self?.Returns_3Y)}%
              </Text>
              : <Text style={[styles.statisticsValue, { color: "#F00" }]}>
                {getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.self?.Returns_3Y)}%
              </Text>
          ...
          <View>
            {etfSummary?.performance?.avgAnnualReturns?.index?.Returns_3Y &&
              etfSummary?.performance?.avgAnnualReturns?.index?.Returns_3Y > 0 ?
              <Text style={[styles.statisticsValue, { color: "#2EBD85" }]}>
                +{getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.index?.Returns_3Y)}%
              </Text>
              : <Text style={[styles.statisticsValue, { color: "#F00" }]}>
                {getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.index?.Returns_3Y)}%
              </Text>
        ...
        <View style={[globalStyle.justifyBetween, { marginTop: 13 }]}>
          <View style={[globalStyle.justifyBetween, { width: '60%' }]}>
            ...
            {etfSummary?.performance?.avgAnnualReturns?.self?.Returns_5Y &&
              etfSummary?.performance?.avgAnnualReturns?.self?.Returns_5Y > 0 ?
              <Text style={[styles.statisticsValue, { color: "#2EBD85" }]}>
                +{getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.self?.Returns_5Y)}%
              </Text>
              : <Text style={[styles.statisticsValue, { color: "#F00" }]}>
                {getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.self?.Returns_5Y)}%
              </Text>
          ...
          <View>
            {etfSummary?.performance?.avgAnnualReturns?.index?.Returns_5Y &&
              etfSummary?.performance?.avgAnnualReturns?.index?.Returns_5Y > 0 ?
              <Text style={[styles.statisticsValue, { color: "#2EBD85" }]}>
                +{getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.index?.Returns_5Y)}%
              </Text>
              : <Text style={[styles.statisticsValue, { color: "#F00" }]}>
                {getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.index?.Returns_5Y)}%
              </Text>
        ...
        <View style={[globalStyle.justifyBetween, { marginTop: 13 }]}>
          <View style={[globalStyle.justifyBetween, { width: '60%' }]}>
            ...
            {etfSummary?.performance?.avgAnnualReturns?.self?.Returns_10Y &&
              etfSummary?.performance?.avgAnnualReturns?.self?.Returns_10Y > 0 ?
              <Text style={[styles.statisticsValue, { color: "#2EBD85" }]}>
                +{getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.self?.Returns_10Y)}%
              </Text>
              : <Text style={[styles.statisticsValue, { color: "#F00" }]}>
                {getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.self?.Returns_10Y)}%
              </Text>
          ...
          <View>
            {etfSummary?.performance?.avgAnnualReturns?.index?.Returns_10Y &&
              etfSummary?.performance?.avgAnnualReturns?.index?.Returns_10Y > 0 ?
              <Text style={[styles.statisticsValue, { color: "#2EBD85" }]}>
                +{getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.index?.Returns_10Y)}%
              </Text>
              : <Text style={[styles.statisticsValue, { color: "#F00" }]}>
                {getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.index?.Returns_10Y)}%
              </Text>
        ...
        <View style={[globalStyle.justifyBetween, { marginTop: 13 }]}>
          <View style={[globalStyle.justifyBetween, { width: '60%' }]}>
            ...
            {etfSummary?.performance?.avgAnnualReturns?.self?.Returns_YTD &&
              etfSummary?.performance?.avgAnnualReturns?.self?.Returns_YTD > 0 ?
              <Text style={[styles.statisticsValue, { color: "#2EBD85" }]}>
                +{getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.self?.Returns_YTD)}%
              </Text>
              : <Text style={[styles.statisticsValue, { color: "#F00" }]}>
                {getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.self?.Returns_YTD)}%
              </Text>
          ...
          <View>
            {etfSummary?.performance?.avgAnnualReturns?.index?.Returns_YTD &&
              etfSummary?.performance?.avgAnnualReturns?.index?.Returns_YTD > 0 ?
              <Text style={[styles.statisticsValue, { color: "#2EBD85" }]}>
                +{getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.index?.Returns_YTD)}%
              </Text>
              : <Text style={[styles.statisticsValue, { color: "#F00" }]}>
                {getRoundOffValue(etfSummary?.performance?.avgAnnualReturns?.index?.Returns_YTD)}%
              </Text>
      ...
      <View style={globalStyle.container}>
        ...
        <View style={[globalStyle.justifyCenter, { gap: 30, alignItems: 'center'}]}>
          <View style={{ flexDirection: 'column', gap: 8 }}>
            ...
            <Text style={{ color: '#FFF', fontSize: 12 }}>{etfSummary?.performance?.riskreturnComparison?.self?.risk}%</Text>
            <Text style={{ color: '#FFF', fontSize: 12 }}>{etfSummary?.performance?.riskreturnComparison?.self?.return}%</Text>
          </View>
          ...
          <View style={{ flexDirection: 'column', gap: 8 }}>
            ...
            <Text style={{ color: '#FFF', fontSize: 12 }}>{etfSummary?.performance?.riskreturnComparison?.index?.risk}%</Text>
            <Text style={{ color: '#FFF', fontSize: 12 }}>{etfSummary?.performance?.riskreturnComparison?.index?.return}%</Text>
          </View>
        </View>
      </View>
      <View style={[globalStyle.divider, { marginTop: 26 }]}></View>
      <View style={globalStyle.container}>
        ...
        <View style={[globalStyle.justifyCenter, { marginTop: 12, gap: 35 }]}>
          <TouchableOpacity onPress={() => getStockHistoricalData(etfSummary?.performance?.hypotheticalGrowth, "1y")}>
            <Text
              style={{
          ...
          <TouchableOpacity onPress={() => getStockHistoricalData(etfSummary?.performance?.hypotheticalGrowth, "3y")}>
            <Text
              style={{
          ...
          <TouchableOpacity onPress={() => getStockHistoricalData(etfSummary?.performance?.hypotheticalGrowth, "5y")}>
            <Text
              style={{
          ...
          <TouchableOpacity onPress={() => getStockHistoricalData(etfSummary?.performance?.hypotheticalGrowth, "10y")}>
            <Text
              style={{
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', gap: 30, alignItems: 'center', marginTop: 30 }}>
          <View style={{ flexDirection: 'column', gap: 8 }}>
            ...
            <Text style={{ color: '#FFF', fontSize: 12 }}>{parseInt(selfIndexMax.self).toLocaleString()}$</Text>
          </View>
          ...
          <View style={{ flexDirection: 'column', gap: 8 }}>
            ...
            <Text style={{ color: '#FFF', fontSize: 12 }}>{parseInt(selfIndexMax.index).toLocaleString()}$</Text>
          </View>
        </View>
      </View>
    </ScrollView>
