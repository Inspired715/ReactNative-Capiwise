      ...
      <View style={[globalStyle.justifyBetween, globalStyle.flexColumn, {height:'100%'}]}>
        <View style={globalStyle.container}>
          ...
          <Text style={{ fontSize: 16, marginTop: 20, color: '#FFF', textAlign:'center' }}>
            You will receive an email containing a verification PIN at email {email}
          </Text>
        ...
        <Text
          style={{ textAlign: 'center', fontWeight: 400, fontSize: 10, color: "#979797", }}>
          It helps us keep your account secure.&nbsp;
          <Text style={{ fontWeight: 600, textDecorationLine: "underline", fontSize: 10, color: "#FFF", }}>
            Learn more
          </Text>
        </Text>
      </View>
